// Path: QuickTechSystems.WPF/ViewModels/SystemPreferencesViewModel.cs
...
namespace QuickTechSystems.WPF.ViewModels
{
    public class SystemPreferencesViewModel : ViewModelBase
    {
        ...
        private SystemPreferenceDTO? _selectedPreference;
        ...
        public SystemPreferencesViewModel(ISystemPreferencesService preferencesService)
        {
        ...
        private async Task LoadPreferencesAsync()
        {
            try
            {
                // Hard-coded user ID for now - you should get this from your authentication system
